            ...
            <div className='container mx-auto'>
             ...
             {/* text  */}
                 <div className=' max-w-[400px] mx-auto xl:mx-0 text-center xl:text-left mb-12b xl:h-[400px] flex flex-col justify-center items-center xl:items-start'>
                      ...
                      <p className='subtitle mb-8'> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vitae ad laborum suscipit, voluptate iste consequuntur porro nulla maiores</p>
